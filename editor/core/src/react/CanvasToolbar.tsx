...
import { type TLUiActionsContextType, useActions, useEditor, useTools, useValue } from 'tldraw'
    ...
    >
      ...
      {handleSave ? (
        <>
          ...
          <ToolbarButton icon={Save} label="保存" onClick={handleSave} shortcut="Ctrl+S" />
        </>
      ) : null}
    </div>
  )
