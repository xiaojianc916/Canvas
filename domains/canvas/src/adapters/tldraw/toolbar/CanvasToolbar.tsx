...
import { ArrowRight, Hand, MousePointer2, Pencil, Shapes, StickyNote, Type } from 'lucide-react'
...
export function CanvasToolbar({ editor }: CanvasToolbarProps) {
  const activeToolId = useValue('active canvas tool', () => editor.getCurrentToolId(), [editor])
